            ...
            <div class="col-xs-12 col-sm-8 col-md-4 col-sm-offset-2 col-md-offset-4">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title text-center">Donor</h3>
                    </div>
                        ...
                        <form role="form" action="Payment.html">
                            <div class="form-group">
                                <select name="state" class="form-control input-sm placeholder">
                                    ...
                                    <option value="AL">Donor1</option>
                                    <option value="AK">Donor2</option>
                                </select>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <input type="number" name="email" id="email" class="form-control input-sm" placeholder="Total Donation">
                            </div>
