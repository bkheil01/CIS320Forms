            ...
            <div class="col-xs-12 col-sm-8 col-md-4 col-sm-offset-2 col-md-offset-4">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title text-center">Class Registration Form</h3>
                    </div>
                    <div class="panel-body">
                        <form role="form" action="Payment.html">
                            ...
                            <div class="form-group">
                                ...
                                <label><input type="radio" name="optradio">Cash/Check</label>
                                <label><input type="radio" name="optradio">PayPal</label>
                                <label><input type="radio" name="optradio">Card</label>
                                <label><input type="radio" name="optradio">Scholarship</label>                                
                            </div> 

                            <input type="submit" value="Register" class="btn btn-info btn-block" formaction="Payment.html">
                        </form>
                    </div>
                </div>
            </div>
