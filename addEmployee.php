				...
				<div class="col-xs-12 col-sm-8 col-md-4 col-sm-offset-2 col-md-offset-4">
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title text-center">Employee</h3>
						</div>
						<div class="panel-body">
							<form role="form">
								...
								<div class="form-group">
									<input type="number" class="form-control input-sm" placeholder="Salary">
								</div>
								<div class="form-group">
									<input type="text" class="form-control input-sm" placeholder="Position">
								</div>
								<div class="form-group">
									<input type="date" class="form-control input-sm" placeholder="Start Date">
								</div>
