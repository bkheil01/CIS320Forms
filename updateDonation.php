                ...
                <div class="col-xs-12 col-sm-8 col-md-4 col-sm-offset-2 col-md-offset-4">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title text-center">Donation</h3>
                        </div>
                        <div class="panel-body">
                            <form role="form" action="Payment.html">
                                <div class="form-group">
                                    <select name="state" class="form-control input-sm placeholder">
                                        <option value="" selected disabled>Select Donation</option>
                                        <option value="AL">Donation1</option>
                                        <option value="AK">Donation2</option>
                                    </select>
                                </div>
                                <div class="form-group">
